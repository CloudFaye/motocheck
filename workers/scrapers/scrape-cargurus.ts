		...
		const data = await page.evaluate(() => {
			...
			try {
				...
				const listingContainer =
					document.querySelector('[data-cg-ft="car-blade"]') ||
				...
				const priceEl =
					listingContainer.querySelector('[data-cg-ft="listing-price"]') ||
				...
				const priceRatingEl =
					listingContainer.querySelector('[data-cg-ft="deal-rating"]') ||
				...
				const marketAvgEl =
					listingContainer.querySelector('[data-cg-ft="market-average"]') ||
				...
				const daysOnMarketEl =
					listingContainer.querySelector('[data-cg-ft="days-on-market"]') ||
				...
				const yearEl =
					listingContainer.querySelector('[data-cg-ft="year"]') ||
				...
				const makeEl =
					listingContainer.querySelector('[data-cg-ft="make"]') ||
				...
				const modelEl =
					listingContainer.querySelector('[data-cg-ft="model"]') ||
				...
				const trimEl =
					listingContainer.querySelector('[data-cg-ft="trim"]') ||
				...
				// Extract mileage
				const mileageEl =
					listingContainer.querySelector('[data-cg-ft="mileage"]') ||
				...
				// Extract dealer name
				const dealerEl =
					listingContainer.querySelector('[data-cg-ft="seller-name"]') ||
				...
				const locationEl =
					listingContainer.querySelector('[data-cg-ft="seller-location"]') ||
...
export async function registerScrapeCarGurusWorker(queue: PgBoss): Promise<void> {
	await queue.work(Jobs.SCRAPE_CARGURUS, handleScrapeCarGurus);

	console.log(
		'[scrape-cargurus] Worker registered (optional source - pipeline continues on failure)'
	);
}
