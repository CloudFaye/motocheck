<script lang="ts">
  ...
  function handleVinInput(e: Event) {
    ...
    vin = formatVin(target.value).slice(0, 17);
    vinError = '';
  }
  ...
  function handleSubmit(e: Event) {
    ...
    isLoading = true;
    // Navigate to report flow — replace with actual SvelteKit goto
    setTimeout(() => {
      window.location.href = `/report?vin=${vin}`;
    }, 400);
  }
...
<section class="relative bg-white overflow-hidden">
  ...
  <div class="absolute inset-0 pointer-events-none">
    ...
    <div class="absolute bottom-0 right-0 w-[600px] h-[500px] bg-gradient-to-tl from-gold-100/50 via-transparent to-transparent rounded-full blur-3xl"></div>
  </div>
  ...
  <div class="container-wide relative z-10 pt-20 pb-24 md:pt-28 md:pb-32">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      ...
      <div class="animate-fade-up">
        ...
        <!-- Eyebrow badge -->
        <div class="inline-flex items-center gap-2 mb-6 px-3 py-1.5 bg-surface-subtle border border-surface-border rounded-full">
          <span class="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse-soft"></span>
          <span class="text-xs font-medium font-sans text-ink-muted">Trusted by 10,000+ importers across Nigeria</span>
        </div>
        ...
        <p class="body-lg max-w-md mb-10">
          Enter a VIN. Get a comprehensive vehicle history, accurate NCS import duty calculation, and safety recall data — delivered instantly to your inbox.
        </p>

        <!-- VIN Form -->
        <form id="vin-form" on:submit={handleSubmit} class="w-full max-w-md">
          ...
          <div class="relative">
            <input
              ...
              class:border-red-300={vinError}
              class:focus:ring-red-200={vinError}
              placeholder="1HGBH41JXMN109186"
              value={vin}
              on:input={handleVinInput}
              maxlength="17"
              autocomplete="off"
              spellcheck="false"
            />
            <!-- Character counter -->
            <span class="absolute right-4 top-1/2 -translate-y-1/2 font-mono text-xs font-medium tabular-nums"
          ...
          {#if vinError}
            <p class="mt-2 text-xs font-sans text-red-500">{vinError}</p>
          {:else}
            <p class="mt-2 text-xs text-ink-faint font-sans">Found on your dashboard, door jamb, or registration document.</p>
          {/if}

          <button type="submit" class="btn-gold w-full mt-4 justify-center py-4 text-base" disabled={isLoading}>
            {#if isLoading}
              <svg class="animate-spin w-4 h-4" viewBox="0 0 16 16" fill="none">
                <circle cx="8" cy="8" r="6" stroke="currentColor" stroke-width="2" stroke-dasharray="16" stroke-dashoffset="8" stroke-linecap="round"/>
              </svg>
              Generating report…
            {:else}
              Get Instant Report
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                <path d="M3 8h10M9 4.5L12.5 8 9 11.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            {/if}
          </button>
            ...
            {#each ['Instant delivery', 'Paystack secured', '₦2,500 flat fee'] as trust}
              <span class="flex items-center gap-1.5 text-xs text-ink-muted font-sans">
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                  ...
                  <path d="M3.5 6L5 7.5 8.5 4" stroke="#10b981" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                {trust}
              </span>
            {/each}
      ...
      <div class="hidden lg:flex items-center justify-center animate-fade-up animate-delay-200">
        <div class="relative w-full max-w-sm">
          ...
          <div class="card p-0 overflow-hidden">
            <!-- Card header -->
            <div class="flex items-center justify-between px-6 py-4 border-b border-surface-border bg-surface-warm">
              <div class="flex items-center gap-2.5">
                <div class="w-7 h-7 rounded-md bg-ink flex items-center justify-center">
                  <svg width="13" height="13" viewBox="0 0 16 16" fill="none" class="text-white">
                    <path d="M3 9.5L4.5 5.5h7L13 9.5" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>
                    <rect x="2" y="9.5" width="12" height="3.5" rx="1" stroke="currentColor" stroke-width="1.3"/>
            ...
            <div class="px-6 py-5 space-y-4">
              <div>
                <p class="text-2xs uppercase tracking-widest text-ink-faint font-sans mb-1">Vehicle</p>
              ...
              <div>
                <p class="text-2xs uppercase tracking-widest text-ink-faint font-sans mb-2">Import Duty Summary</p>
                <div class="space-y-1.5">
                  {#each [
                    { label: 'CIF Value (USD)', value: '$12,500' },
                    { label: 'Import Duty (35%)', value: '₦15,312,500' },
                    { label: 'VAT (7.5%)', value: '₦2,109,375' },
                    { label: 'Port Charges', value: '₦185,000' },
                  ] as row}
                ...
                <div class="mt-3 pt-3 border-t border-surface-border flex justify-between items-center">
                  <span class="text-xs font-semibold font-sans text-ink">Total Estimate</span>
                  <span class="text-sm font-bold font-sans text-gold-600 tabular-nums">₦17,606,875</span>
                </div>
              </div>
              ...
              <div class="flex items-center gap-2">
                <svg class="w-3.5 h-3.5 text-emerald-500 flex-shrink-0" viewBox="0 0 14 14" fill="none">
                  <circle cx="7" cy="7" r="6" stroke="currentColor" stroke-width="1.2"/>
                  <path d="M4 7L6 9l4-4" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
          ...
          <!-- Floating badge -->
          <div class="absolute -top-3 -right-3 bg-ink text-white rounded-xl px-3 py-2 shadow-lifted">
  ...
  <div class="border-t border-surface-border bg-surface-subtle">
    <div class="container-wide py-6">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-0 md:divide-x divide-surface-border">
        {#each [
          { value: '10,000+', label: 'Reports generated'   },
          { value: '₦2,500',  label: 'Flat fee, no hidden charges' },
...
<section id="how-it-works" class="section-pad bg-white">
  <div class="container-wide">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
      ...
      <div class="hidden md:block absolute top-9 left-[20%] right-[20%] h-px bg-surface-border z-0"></div>

      {#each [
        {
          n: '01',
          title: 'Enter your VIN',
          desc: 'Paste or type your 17-character VIN into the form. We validate it in real time against the NHTSA database.',
          icon: `<path d="M5 2h6l2 3H3L5 2z" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round"/><rect x="2" y="5" width="12" height="9" rx="1.5" stroke="currentColor" stroke-width="1.3"/>`
        },
        {
          n: '02',
          title: 'Pay securely',
          desc: 'Complete your ₦2,500 payment via Paystack using any card, bank transfer, or USSD. Takes under 30 seconds.',
          icon: `<rect x="2" y="4" width="12" height="9" rx="1.5" stroke="currentColor" stroke-width="1.3"/><path d="M2 7.5h12" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"/><circle cx="6" cy="10" r="1" fill="currentColor"/>`
        },
        {
          n: '03',
          title: 'Get your report',
          desc: 'A detailed PDF report lands in your inbox instantly, covering specs, duty breakdown, recalls, and NCS valuation.',
          icon: `<rect x="3" y="2" width="10" height="13" rx="1.5" stroke="currentColor" stroke-width="1.3"/><path d="M6 5h4M6 7.5h4M6 10h2.5" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"/>`
        },
      ] as step, i}
        <div class="card-surface relative z-10">
          <div class="flex items-start gap-4">
            <div class="w-9 h-9 rounded-xl border-2 border-gold-400 text-gold-500 flex items-center justify-center flex-shrink-0">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-start">
      ...
      <div class="lg:col-span-2 lg:sticky lg:top-24">
        ...
        <p class="body-base mb-8">
          We pull data from NHTSA, official NCS valuation tables, and OEM records so nothing is left out of your purchasing decision.
        </p>
        <a href="/sample-report" class="btn-ghost">
          View a sample report
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
            <path d="M3 7h8M8 4.5L10.5 7 8 9.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </a>
      </div>
      ...
      <div class="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 gap-4">
        {#each inspects as item}
          <div class="card group hover:shadow-lifted transition-shadow duration-300">
            <div class="feature-icon">
              <svg width="18" height="18" viewBox="0 0 16 16" fill="none">
                {@html item.icon}
              </svg>
            </div>
            <h4 class="text-sm font-semibold text-ink mb-1.5 group-hover:text-gold-600 transition-colors">{item.title}</h4>
...
<section id="pricing" class="section-pad bg-white">
  <div class="container-wide">
    <div class="max-w-2xl mx-auto text-center">
      ...
      <p class="body-base mb-10 max-w-md mx-auto">No subscriptions, no upsells. Pay once per VIN and get the full report — specs, duty, recalls, and NCS valuation.</p>

      <!-- Pricing card -->
      <div class="card max-w-sm mx-auto border-2 border-ink/[0.06] relative overflow-hidden">
        <!-- Gold accent bar -->
        <div class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-gold-400 to-gold-300"></div>
        ...
        <div class="pt-3">
          ...
          <ul class="text-left space-y-3 mb-8">
            {#each [
              ...
              'Line-by-line import duty calculation',
              'NCS reference valuation',
              'Active safety recall check',
              ...
              <li class="flex items-center gap-3 text-sm font-sans text-ink-soft">
                <svg class="w-4 h-4 text-emerald-500 flex-shrink-0" viewBox="0 0 16 16" fill="none">
          ...
          <p class="text-xs text-ink-faint mt-3 font-sans">Secured by Paystack · All cards accepted</p>
        </div>
      </div>
    </div>
  </div>
      ...
      {#each [
        {
          ...
          location: 'Lagos',
          role: 'Private importer',
          quote: 'Saved me thousands. The duty calculation was exact — I used it to negotiate the final price with my clearing agent before the car even left the US.',
          stars: 5
        },
        {
          initials: 'CN',
          ...
          location: 'Abuja',
          role: 'Car dealer',
          quote: 'My customers ask about duties before they commit. I now send them a MotoCheck report at enquiry stage. It builds trust and closes deals faster.',
          stars: 5
        },
        {
          initials: 'EM',
          ...
          role: 'Fleet manager',
          quote: 'Bought three vehicles last quarter. MotoCheck caught an undisclosed recall on one — that alone was worth every kobo.',
          stars: 5
        },
      ] as t}
    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
      ...
      <div class="lg:col-span-2">
        ...
        <p class="body-base">
          ...
          <a href="mailto:support@motocheck.ng" class="text-gold-600 hover:underline underline-offset-4">Email our support team.</a>
        </p>
      </div>
...
<section class="section-pad bg-ink">
  <div class="container-wide text-center">
    ...
    <p class="text-base text-white/60 font-sans font-light max-w-md mx-auto mb-10">
      Join over 10,000 Nigerian importers who use MotoCheck to verify vehicle history and calculate duties before committing.
    </p>
    ...
    <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
      ...
      <a href="/sample-report" class="inline-flex items-center gap-2 text-sm font-medium font-sans text-white/60 hover:text-white transition-colors">
