...
// ============================================================================
// EXISTING TABLES (Preview / payment compatibility flow)
// ============================================================================
...
/**
 * Orders table - Tracks payment transactions from the preview/checkout flow
 * Links cached lookups to payment processing
 */
...
/**
 * Reports table - Legacy delivery metadata kept for backward compatibility
 * The active asynchronous report pipeline uses `pipeline_reports` below
 */
